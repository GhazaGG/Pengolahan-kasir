    ...
    <body class="sb-nav-fixed">
        ...
        <div class="modal-dialog">
            ...
            <form method ="POST">
                ...
                <div class="modal-body">
                    <input type="text" name="nomerhp" class="form-control" placeholder="Nomer HP" >
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" name="tambahpelanggan" data-bs-dismiss="modal">Tambah</button>
