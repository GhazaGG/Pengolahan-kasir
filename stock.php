    ...
    <body class="sb-nav-fixed">
        ...
        <div class="modal-dialog">
            ...
            <form method ="POST">
                ...
                <div class="modal-body">
                    <input type="num" name="harga" class="form-control" placeholder="Harga" >
                </div>
                <div class="modal-body">
                    <input type="num" name="stock" class="form-control" placeholder="Stock" >
                </div>
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" name="tambahbarang" data-bs-dismiss="modal">Tambah</button>
