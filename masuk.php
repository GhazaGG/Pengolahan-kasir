    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                            $get = mysqli_query($koneksi,"Select * from masuk");
                                            $i = 1;
        ...
        <div class="modal-dialog">
            ...
            <form method ="POST">
                ...
                <div class="modal-body">
                    <input type="text" name="qtty" class="form-control" placeholder="Jumlah Barang masuk" >
                </div>
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" name="barangmasuk" data-bs-dismiss="modal">Tambah</button>
